...
HD_PWD='c:/users/asus/desktop/crstuff/diceroller/diceroller.tmp/dicenumbergeneratorcop_v1_0_project/DiceNumberGeneratorCop_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DiceNumberGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DiceNumberGenerator.tcl
